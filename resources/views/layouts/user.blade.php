                ...
                <div class="author-page author vcard inline-items">
                    ...
                    <a href="{{url("user")}}" class="author-name fn">
                        <div class="author-title">
                            Anukkrit Shanker <svg class="olymp-dropdown-arrow-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                        </div>
            ...
            <div class="ui-block">
                <div class="top-header">
                        ...
                        <div class="row">
                            <div class="col col-lg-5 col-md-5 col-sm-12 col-12">
                                <ul class="profile-menu">
                                    <li>
                                        <a href="{{url("user")}}" class="active">Timeline</a>
                                    </li>
                                    <li>
                    ...
                    <div class="top-header-author">
                        <a href="{{url("user")}}" class="author-thumb">
                            <img src="img/author-main1.jpg" alt="author">
                        </a>
                        <div class="author-content">
                            <a href="{{url("user")}}" class="h4 author-name">Anukkrit Shanker</a>
                    ...
                    <article class="hentry post">
                        ...
                        <div class="post__author author vcard inline-items">
                            ...
                            <div class="author-date">
                                <a class="h6 post__author-name fn" href="{{url("user")}}">Anukkrit Shanker</a>
                ...
                <div class="ui-block">
                    ...
                    <article class="hentry post video">
                        ...
                        <div class="post__author author vcard inline-items">
                            ...
                            <div class="author-date">
                                <a class="h6 post__author-name fn" href="{{url("user")}}">Anukkrit Shanker</a> shared a
                                <a href="#">link</a>
                                <div class="post__date">
                                    <time class="published" datetime="2017-03-24T18:18">
                                        7 hours ago
                ...
                <div class="ui-block">
                    ...
                    <article class="hentry post has-post-thumbnail shared-photo">
                        ...
                        <div class="post__author author vcard inline-items">
                            ...
                            <div class="author-date">
                                <a class="h6 post__author-name fn" href="{{url("user")}}">Anukkrit Shanker</a> shared
